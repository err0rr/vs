        ...
        <ul class="sidebar-menu">
            ...
            @permission('manage-users')
                <li class="{{ Active::pattern('admin/access/*') }}">
                    {{ link_to_route('admin.access.user.index', 'User Management') }}
                </li>
            @endauth
            ...
            <li class="{{ Active::pattern('admin/services') }}">
                <a href="{!! url('admin/services') !!}">{{ trans('Services ') }}</a>
            </li>
            <li class="{{ Active::pattern('admin/sliders') }}">
                <a href="{!! url('admin/sliders') !!}">{{ trans('Sliders') }}</a>
            </li>  
			
			<li class="{{ Active::pattern('admin/contactus') }}">
                <a href="{{ route('contactUs') }}">
                    <span>{{ trans('Contact us') }}</span>
                    
                </a>    
            </li>
            <li class="{{ Active::pattern('admin/faqs')}} treeview">
                <a href="{{route('faqs')}}">
            ...
            <li class="{{ Active::pattern('admin/languages')}} treeview">
            ...
            <li class="{{ Active::pattern('admin/review')}} treeview">
                <a href="{{route('review')}}">
            ...
            <li class="{{ Active::pattern('admin/listtimeslot')}} treeview">
                <a href="{{route('listtimeslot')}}">
