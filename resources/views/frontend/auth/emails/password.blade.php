...
<body style="background: #f9f9f9;font-family: 'CenturyGothic';">
    ...
    <thead>
      <tr>
        ...
        <tr>  
            <td colspan="2"><img src="{!! URL::to('img/email/images/ban3.png') !!}" style="width: 100%"></td>
        </tr>
        <tr>  
            <td colspan="2"><h4 style="text-align: center;margin:20px;font-size: 45px;">Forgot Your Password?</h4></td>
        </tr>
        <tr>  
            <td colspan="2"><p style="margin:10px 0px 15px;padding: 0px 10px">Hi @if(!isset($username) && !empty($username))  {{ ucfirst($username) }} @endif ,</p></td>
        </tr>
        <tr>  
            <td colspan="2" style="padding: 0px 10px">It looks like you requested a new password.</td>
        </tr>
        <tr>  
            <td colspan="2" style="padding: 0px 10px">If that sounds right, you can enter a new password</td>
            <tr>  
            <td colspan="2" style="padding: 0px 10px">by clicking on the button below</td>
        </tr>
      
        <tr style="text-align: center;">  
            <td colspan="2" style="padding: 30px 5px 20px;"><a href="{{ url('password/reset/'.$token) }}" style="text-align: center;color: #fff;background: #ffb200;padding: 10px 20px;border-radius: 5px;text-decoration: none;">Confirm Your Account!</a></td>
        </tr>
        </tbody>
    </table>
    <table style="width: 800px;border: none;color: #333;margin:30px auto;font-size: 25px;text-align: center;">
      ...
      <tr>
          ...
          <tr>
            <td colspan="2"><a href="{{ url('password/reset/'.$token) }}" style="color: #71bbe6;text-decoration: none;">{{ url('password/reset/'.$token) }}</a></td>
          </tr>
          <tr>
