...
<body style="background: #f9f9f9;font-family: 'CenturyGothic';">
    ...
    <thead>
      <tr>
        ...
        <tr>  
            <td colspan="2"><img src="{!! URL::to('img/email/images/ban6.png') !!}" style="width: 100%"></td>
        </tr>
        <tr>  
            <td colspan="2"><h4 style="text-align: center;margin:20px;font-size: 45px;">Forgot Your Password?</h4></td>
        </tr>
        <tr>  
            <td colspan="2"><p style="margin:10px 0px 15px;padding: 0px 10px">Hi {{ ucfirst($username) }},</p></td>
        </tr>
        <tr>  
