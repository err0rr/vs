...
<body style="background: #f9f9f9;font-family: 'CenturyGothic';">
    ...
    <thead>
      <tr>
        ...
        <tr>  
            <td colspan="2"><img src="{!! URL::to('img/email/images/ban2.png') !!}" style="width: 100%"></td>
        </tr>
        <tr>  
        ...
        <tr>  
            <td style="padding: 0px 10px">Title</td><td style="padding: 0px 10px">: {{ ucfirst($titleescort) }}</td>
        </tr>
        <tr>  
