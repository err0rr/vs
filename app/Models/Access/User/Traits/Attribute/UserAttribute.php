...
trait UserAttribute
{
    ...
    {
        return '<a href="' . route('admin.access.user.view', $this) . '" class="btn btn-xs btn-primary"><i class="fa fa-eye" data-toggle="tooltip" data-placement="top" title="' . trans('View') . '"></i></a> ';
    }
